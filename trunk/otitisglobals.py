...
preferences = {
    ...
    'log':           False,                #Log IRC channel?
    'logsDirectory': 'botlogs/',           #Directory reverts logs
    'newbie':        25,                   #Who is a newbie user? How many edits?
    'statsDelay':    60*15,                   #How many seconds between showing stats in screen
    'colors':        {
        'sysop': 'lightblue',
        'bot':   'lightpurple',
        'reg':   'lightgreen',
...
""" Header message """
header  = u"\nOtitis Copyright (C) 2009-2010 emijrp\n"
...
header += u"############################################################################\n\n"
header += u"Parameters available (* obligatory): -lang, -family, -newbie, -botnick*, -statsdelay, -network, -channel, -ownernick*, -log\n"
